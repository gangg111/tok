...
## ⚡ Latency (mean of 30 runs after warm-up; phone — Termux/aarch64)
...
> Same method, re-run on a desktop PC (2026-06-12): **rtk.exe 0.42.3**
> (prebuilt Windows binary) vs **tok.exe** built on the spot
...
<table>
  ...
  <tr><td>startup (<code>--version</code>)</td><td align="right">21.7 ms</td><td align="right"><b>10.8 ms</b></td><td align="center">✅ tok 2.0×</td></tr>

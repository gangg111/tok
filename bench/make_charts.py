...
bar_chart(
    ...
    [
        ...
        ("result bytes — PC, round 1", 100, "1699 B", 111.3, "1891 B"),
        ("result bytes — PC, rematch", 100, "1699 B", 75.8, "1287 B"),
        ("tokens, ws — phone (Termux)", 100, "357", 88.0, "314"),
        ("tokens, ws — PC, round 1", 100, "208", 106.3, "221"),
        ("tokens, ws — PC, rematch", 100, "208", 76.9, "160"),
        ("tokens, BPE — phone (Termux)", 100, "1122", 89.4, "1003"),
        ("tokens, BPE — PC, round 1", 100, "642", 108.9, "699"),
        ("tokens, BPE — PC, rematch", 100, "642", 74.8, "480"),
        ("wall-time — phone (Termux)", 100, "97.2 s", 83.9, "81.5 s"),
        ("wall-time — PC, round 1", 100, "98.3 s", 115.5, "113.5 s"),
        ("wall-time — PC, rematch", 100, "96.7 s", 98.3, "95.1 s"),
    ],
    120, (25, 50, 75, 100), "%",
    note="phone + PC rematch: tok won · PC round 1: rtk won (tok's old per-suite cargo tally cost one extra verify run; fixed since) · rtk traffic byte-identical in both PC rounds · all six lanes: 4/4 PASS + commit",
)

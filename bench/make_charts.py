...
bar_chart(
    ...
    [
        ...
        ("result bytes — PC", 100, "1699 B", 75.8, "1287 B"),
        ("tokens, ws — phone (Termux)", 100, "357", 88.0, "314"),
        ("tokens, ws — PC", 100, "208", 76.9, "160"),
        ("tokens, BPE — phone (Termux)", 100, "1122", 89.4, "1003"),
        ("tokens, BPE — PC", 100, "642", 74.8, "480"),
        ("wall-time — phone (Termux)", 100, "97.2 s", 83.9, "81.5 s"),
        ("wall-time — PC", 100, "96.7 s", 98.3, "95.1 s"),
    ],
    100, (25, 50, 75, 100), "%",
    note="PC = current tok (after the cargo-tally fix); pre-fix tok lost the first PC round — full history in the data table · all lanes: 4/4 PASS + commit",
)
